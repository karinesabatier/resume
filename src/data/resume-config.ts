...
export const resumeConfig: ResumeConfig = {
  ...
  skills: [
    ...
    },
    {
      ...
      type: 'text',
      items: [
        { name: { fr: 'XP, Kanban, Lean Startup, Lean UX, Design Thinking', en: 'XP, Kanban, Lean Startup, Lean UX, Design Thinking' } },
      ],
    },
    {
  ...
  experiences: [
    ...
    },
    {
      ...
      details: {
        context: {
          en: 'Le groupe Sinari est un éditeur de plusieurs dizaines de logiciels pour les industries du transport, de la logistique et de la chaîne d\'approvisionnement.',
          fr: 'Le groupe Sinari est un éditeur de plusieurs dizaines de logiciels pour les industries du transport, de la logistique et de la chaîne d\'approvisionnement.',
        },
        tasks: {
          en: [
            'Refonte UX : modernisation UX des produits et gestion du legacy',
            'Création d\’une équipe UX et repositionnement du rôle UX au sein du groupe',
            ...
            'Animation des Handoffs UX <> dev',
            'Product Design : conception d\’une solution Saas globale. Cela inclut',
            'Conception de l\’architecture fonctionnelle et des parcours utilisateurs',
